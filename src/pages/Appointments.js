        ...
        <Layout style={{backgroundColor:"#000C17"}}>
           ...
           <Col span={6} className='w-full'>
                <div
                    ...
                    className={selected === 'cancelled' ?'h-24 rounded-lg ml-5  bg-gray-900 flex items-center cursor-pointer hover:scale-105 transition transform duration-200 ease-out ' : 'h-24 rounded-lg ml-5  bg-gray-600 flex items-center hover:scale-105 transition transform duration-200 ease-out '}>
                   <div className='ml-5'>
          ...
          <Row style={{}}>
            ...
            <Col span={24}>
                {selected==='pending' &&  <Pending selected={selected} /> }
                {selected==='accepted' &&  <Confirmed selected={selected} /> }
                {selected==='completed' &&  <Complete  selected={selected} /> }
                {selected==='cancelled' &&  <Cancel  selected={selected} /> }
