...
function Confirmed({selected}) {
    ...
    return (
        ...
        <div className="text-green-300 font-semibold text-3xl flex justify-center mt-10 uppercase">You dont have any Confirmed appointments</div>
        : 
        <div className="mt-10">
                                ...
                                <td className="py-3 px-6 text-center">
                                    <div className="flex item-center justify-center">
                                        ...
                                        <Tooltip placement="topLeft" title="Mark as complete">
                                            <CheckCircleIcon onClick={()=>markAsComplete(item?._id)} />
                                        </Tooltip>
                                            
                                        </div>
                                        <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <Tooltip placement="topLeft" title="Mark as canceled">
                                                <TrashIcon  onClick={()=>{
